    ...
    <div className='flex'>
        <div>
            ...
            <ul className="list-disc pl-8 text-black-700 text-lg">
                ...
                <h2 className="text-3xl font-bold text-[#00a79b] mb-2 mt-4">you are someone who is:</h2>
            <ul className="list-disc pl-8 text-black-700 text-lg">
        ...
        <div>
            <h2 className="text-3xl font-bold text-[#00a79b] mb-2">what can you expect in this role :</h2>
            <ul className="list-disc pl-8 text-black-700 text-lg">
