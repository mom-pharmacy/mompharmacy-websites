...
export default function EnquiryForm() {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://api.countrystatecity.in/v1/countries/${countryCode}/states/${selectedStateCode}/cities`,
      {
        headers: { "X-CSCAPI-KEY": API_KEY },
      }
    )
      ...
      <div className="bg-[#00a99d] rounded-2xl p-4 sm:p-6 text-white mb-8">
        ...
        <div className="mb-2 flex items-center">
          <img
            ...
            src="/src/assets/Investors/call.png"
            alt="call"
          />
          <p>+91 7702068334</p>
        </div>
        <div className="mb-2 flex items-center text-[#fadb14]">
          <img
            className="h-5 w-5 mr-2"
            src="/src/assets/Investors/email.png"
            alt="email"
          />
          <p>ps@mompharmacy.in</p>
        </div>
        <div className="flex items-start">
          <img
            className="h-5 w-5 mr-2 mt-1"
            src="/src/assets/Investors/location.png"
            alt="location"
          />
      ...
      <form className="w-full" onSubmit={handleSubmit}>
        <div className="flex flex-col sm:flex-row gap-4 mb-5">
          <div className="w-full sm:w-1/2">
            <label htmlFor="name" className="block mb-2 text-lg font-medium text-teal-500">
              your name *
            </label>
            <input
              type="text"
          ...
          <div className="w-full sm:w-1/2">
            <label htmlFor="mobile" className="block mb-2 text-lg font-medium text-teal-500">
              your contact *
            </label>
            <input
              type="tel"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-5">
          <div className="w-full sm:w-1/2">
            <label htmlFor="email" className="block mb-2 text-lg font-medium text-teal-500">
              your email *
            </label>
            <input
              type="email"
          ...
          <div className="w-full sm:w-1/2">
            <label htmlFor="investment" className="block mb-2 text-lg font-medium text-teal-500">
              investment value *
            </label>
            <input
              type="number"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-5">
          ...
          <div className="w-full sm:w-1/2">
            <label htmlFor="city" className="block mb-2 text-lg font-medium text-teal-500">
              city *
            </label>
            <select
              id="city"
        ...
        <div className="mb-5">
          <label htmlFor="background" className="block mb-2 text-lg font-medium text-teal-500">
