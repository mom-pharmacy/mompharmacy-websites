...
const scale4 = useTransform(scrollYProgress , [0,0.8,1] , [0,3,7])
...
const scale6 = useTransform(scrollYProgress , [0,0] , [0,1])
  ...
  return (
    ...
    <div ref={container} className='h-[500vh] w-screen top-0  flex justify-center items-center relative overflow-x-clip' >
        <div className=' sticky w-screen bg-white  top-0 h-[100vh] mt-[100vh] mb-[100vh]  '>
            <motion.div style={{scale:scale4}} className='bg-white w-screen top-0 absolute '>
                <div  className=' h-[30vh]   '>
                    <p className='flex justify-center items-center text-[250px] text-[#00A79B] '><motion.h1  style={{scale:scale5}}>st</motion.h1><span >
                        <img src="/Home/ourStory.webp" alt="ourstory image" className='h-[250px] w-[250px] rounded-full fill placeholder-blur object-fit '></img>
